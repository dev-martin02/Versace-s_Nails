        ...
        <div className="bg-pink-50 w-full max-w-md p-4 rounded-lg">
            ...
            <ul className="mt-5">
                {nailServices.map(({name, price, description}, index) => (
                    <li key={index} className="mt-1 py-3 border-b border-gray-200 last:border-0">
                        ...
                        {expandedServices[name] && (
                            <div className="mt-6">
                                ...
                                <p className="my-2 px-4 py-2 rounded-lg inline-block bg-rose-100 ">Starting at <span className="font-bold">${price}</span></p>
                                <p>{description}</p>
                                <PopupButton
